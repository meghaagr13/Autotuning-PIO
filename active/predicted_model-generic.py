...
filename="finalgenericxgb_read.sav"
loaded_model = joblib.load(open(filename, 'rb'))
scaler_filename = "scalergenericxgb_read.save"
...
### INITIALIZE THIS MANUALLY ####
   ...
   # Active learning model choosees and saves the values of parameters
    ...
    with open('/home/meghaagr/project/progress/active/confex.json') as f:
        data = json.load(f)
    ...
    col_names =  ['cb5','cb6','cb7','cb8','cb9','cb10','cb11']
...
def storeinfile(hyperparameters):
    ...
    with open("/home/meghaagr/project/progress/active/confex.json","w") as fp:
        json.dump(data,fp)
    print(data)
...
space = {
    ...
    'setstripe-count' : hp.quniform('setstripe-count',1,2,1)
...
print(os.getcwd())
out_file = '/home/meghaagr/project/progress/active/result/gbm_trials-'+file_suffix+'.csv'
...
log = open('genericbestparamsprAct.txt','a')
