...
filename="corifinalxgb_write.sav"
...
### INITIALIZE THIS MANUALLY ####
   ...
   # Active learning model choosees and saves the values of parameters
    storeinfile(hyperparameters)
    with open('/home/dsinghvi/project/progress/confex.json') as f:
        data = json.load(f)
...
def storeinfile(hyperparameters):
    ...
    with open("/home/dsinghvi/project/progress/confex.json","w") as fp:
        json.dump(data,fp)
    print(data)
...
space = {
    ...
    'setstripe-count' : hp.quniform('setstripe-count',0,45,1)
