...
### INITIALIZE THIS MANUALLY ####
   ...
   # Active learning model choosees and saves the values of parameters
    ...
    cb_df.loc[len(cb_df)] = [romio_ds_read, romio_ds_write, stripe_size, stripe_count, cb_buffer_size,str(nx_g/npx),str(ny_g/npy),str(nz_g/npz)]
    ...
    my_df.loc[len(my_df)] = [nx_g,ny_g,nz_g,npx,npy,npz]
