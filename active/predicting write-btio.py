...
xgb_model =xgb_model = xgb.XGBRegressor(objective="reg:linear", max_depth=10,random_state=42,n_estimators=1000)
...
modelfile = 'btiofinalxgbi_read.sav'
joblib.dump(xgb_model, open(modelfile, 'wb'))
scaler_filename = "btioscalerxgb_read.save"
